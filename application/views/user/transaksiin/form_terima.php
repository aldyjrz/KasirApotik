                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <?php echo form_open('transaksi/transaksiin/terima'); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class='input-group date' id='datetimepicker9'>
                                        <input type='text' name="date_mail" id="reservationdate" value="<?php echo $record['date_mail'];?>" readonly class="form-control datetimepicker-input" data-target="#reservationdate"/>
                               ...
                               <div class="form-group">
                                    ...
                                    <select readonly name="kd_pic" class="form-control">
                                ...
                                <select readonly name="kd_logistik" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name='airwaybill' class="form-control" id="exampleInputEmail1" value="<?php echo $record['airwaybill'];?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Shipper Name</label>
                                    <input type="text" name='shipperName' class="form-control" id="exampleInputEmail1" value="<?php echo $record['shipperName'];?>" readonly>
                                </div>

                                <div class="form-group">
                                <label for="exampleSelectBorder">Nama Kota/City</code></label>
                                <select readonly name="kd_kota" class="form-control">
                                ...
                                <select readonly name="nik" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name='additional_Info' class="form-control" id="exampleInputEmail1" value="<?php echo $record['additional_Info'];?>" readonly>
                                </div>

                               
                                <div class="form-group">
                                <label for="exampleSelectBorder">Level Dokumen</code></label>
                                <select readonly name="kd_leveldoc" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="kd_penerima" class="form-control">
                                        <option value="0">Silahkan Pilih</option>
                                        <?php foreach ($penerima as $p) {
                                            echo "<option value='$p->kd_penerima'";
                                            echo $record['kd_penerima']==$p->kd_penerima?'selected':'';
                                            echo">$p->nama_penerima</option>";
                                        } ?>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class='input-group date' id='datetimepicker9'>
                                        <input type='text' name="received_date" id="receiveddate" value="<?php echo $record['received_date'];?>" class="form-control datetimepicker-input" data-target="#receiveddate"/>
                                        <span class="input-group-addon" data-target="#receiveddate" data-toggle="datetimepicker">
                                        <span class="glyphicon glyphicon-calendar">
                                        </span>
                                        </span>
                                    </div>
