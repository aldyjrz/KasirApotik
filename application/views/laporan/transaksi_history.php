 ...
 <script type="text/javascript" language="javascript">
 	$(document).ready(function() {
 		var dataTable = $('#my-grid').DataTable({
 			...
 			"ajax": {
 				url: "<?php echo site_url('transaksi/kasir/history_json'); ?>",
 				type: "post",
 				error: function() {
 					$(".my-grid-error").html("");
 	...
 	$(document).on('click', '#HapusTransaksi', function(e) {
 		...
 		var Check = "<br /><hr style='margin:10px 0px 8px 0px;' /><div class='checkbox'><label><input type='checkbox' name='reverse_stok' value='yes' id='reverse_stok'> Kembalikan stok menu</label></div>";
