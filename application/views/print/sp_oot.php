...
<head>
<title>SP OOT - <?= $transaksi[0]->kode_pesanan?> - APOTEK ILHAM </title>
		...
		<tbody>
			<tr>
				<td   style="border-right:1px solid black;" width="100%" align="center">
					<font style="font-weight:bold;font-size:15px;">SURAT PESANAN OBAT MENGANDUNG OBAT - OBAT TERTENTU FARMASI</font>
				</td>
...
<tr>
			...
			<tr>
				...
				<tr>
				<td style="padding-bottom:12px;border-right:1px solid black" >
					<font style="margin-left:5px" class="big bold">JENIS OBAT MENGANDUNG OBAT - OBAT TERTENTU FARMASI SEBAGAI BERIKUT  :</font>
				</td>
			</tr>
		</tbody>
	</table>
	...
	<table class="main-table" border=1 width="100%" style="margin-top:5px">
		<tbody>
			<tr idth="100%">
				...
				<td class="main-td" align="center" width="30%">
					<font class="big bold">NAMA OBAT</font>
				</td>
				<td class="main-td" align="center" width="20%">
			...
			$no=1; foreach ($transaksi  as $r) { ?>
				<tr>
					...
					<td class="main-td" align="center">(<?= terbilang($r->jumlah)?>)</td>
 				</tr>
				<?php } 
			?>
			<tr >
