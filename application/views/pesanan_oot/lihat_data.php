                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <?php echo anchor('master/Pesanan_oot/add', 'Tambah Data', array('class' => 'btn btn-info btn')) ?>
                            </div>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($record->result() as $r) { ?>
                                                <tr class="gradeU">
                                                    ...
                                                    <td style='width:16%;'><a class='btn btn-info' href='<?=base_url()?>master/Pesanan_oot/detail_transaksi/?term=<?=$r->kode_pesanan ?>' id='LihatDetailTransaksi'><i class='fa fa-file fa-fw'></i> <?php echo $r->kode_pesanan ?></a></td>
                                                    ...
                                                    <td class="center">
                                                        <?php echo "<a target='blank_' class='btn btn-info btn-sm' href='../print/cetak/sp_oot?term=$r->kode_pesanan'><i class='fa fa-print'></i></a> |
                                                    <a class='btn btn-danger btn-sm' href='Pesanan_oot/delete/?kode=$r->kode_pesanan' onClick=\"return confirm('Anda yakin akan menghapus data dari tabel ini?')\"><i class='fa fa-trash'></i></a>"; ?>
                                                    </td>
                                                </tr>
                                            <?php $no++;
                                            }
