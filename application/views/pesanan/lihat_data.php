                                        ...
                                        <tbody>
                                            ...
                                            foreach ($record->result() as $r) { ?>
                                                <tr class="gradeU">
                                                    ...
                                                    <td class="center">
                                                        <?php echo "<a target='blank_' class='btn btn-info btn-sm' href='../print/cetak/sp?term=$r->kode_pesanan'><i class='fa fa-print'></i></a> |
                                                    <a class='btn btn-danger btn-sm' href='pesanan/delete/?kode=$r->kode_pesanan' onClick=\"return confirm('Anda yakin akan menghapus data dari tabel ini?')\"><i class='fa fa-trash'></i></a>"; ?>
                                                    </td>
                                                </tr>
                                            <?php $no++;
                                            } ?>
